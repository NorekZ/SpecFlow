...
namespace TechTalk.SpecFlow
{
    ...
    {
        private const string GivenObsoleteMessage = nameof(Steps) + "." + nameof(GivenAsync) + " is obsolete and will be removed with SpecFlow 3.2. Details: https://github.com/techtalk/SpecFlow/issues/1733";
        private const string WhenObsoleteMessage = nameof(Steps) + "." + nameof(WhenAsync) + " is obsolete and will be removed with SpecFlow 3.2. Details: https://github.com/techtalk/SpecFlow/issues/1733";
        private const string ThenObsoleteMessage = nameof(Steps) + "." + nameof(ThenAsync) + " is obsolete and will be removed with SpecFlow 3.2. Details: https://github.com/techtalk/SpecFlow/issues/1733";
        private const string ButObsoleteMessage = nameof(Steps) + "." + nameof(ButAsync) + " is obsolete and will be removed with SpecFlow 3.2. Details: https://github.com/techtalk/SpecFlow/issues/1733";
        private const string AndObsoleteMessage = nameof(Steps) + "." + nameof(AndAsync) + " is obsolete and will be removed with SpecFlow 3.2. Details: https://github.com/techtalk/SpecFlow/issues/1733";
        ...
        {
            TestRunner.GivenAsync(step, multilineTextArg, tableArg, null);
        }
        #endregion
        ...
        {
            TestRunner.WhenAsync(step, multilineTextArg, tableArg, null);
        }
        #endregion
        ...
        {
            TestRunner.ThenAsync(step, multilineTextArg, tableArg, null);
        }
        #endregion
        ...
        {
            TestRunner.ButAsync(step, multilineTextArg, tableArg, null);
        }
        #endregion
        ...
        {
            TestRunner.AndAsync(step, multilineTextArg, tableArg, null);
        }
        #endregion
    }
}
